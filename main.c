...
int print_token(int token)
{
    ...
    case '|':
        ...
        break;
    case TK_PR_AS:
        print_nome(_(TK_PR_AS));
        break;
    case TK_PR_DECLARE:
        print_nome(_(TK_PR_DECLARE));
        break;
    case TK_PR_ELSE:
        print_nome(_(TK_PR_ELSE));
        break;
    case TK_PR_FLOAT:
        print_nome(_(TK_PR_FLOAT));
        break;
    case TK_PR_IF:
        print_nome(_(TK_PR_IF));
        break;
    case TK_PR_INT:
        print_nome(_(TK_PR_INT));
        break;
    case TK_PR_IS:
        print_nome(_(TK_PR_IS));
        break;
    case TK_PR_RETURN:
        print_nome(_(TK_PR_RETURN));
        break;
    case TK_PR_RETURNS:
        print_nome(_(TK_PR_RETURNS));
        break;
    case TK_PR_WHILE:
        print_nome(_(TK_PR_WHILE));
        break;
    case TK_PR_WITH:
        print_nome(_(TK_PR_WITH));
        break;
    case TK_OC_LE:
        print_nome(_(TK_OC_LE));
        break;
    case TK_OC_GE:
        print_nome(_(TK_OC_GE));
        break;
    case TK_OC_EQ:
        print_nome(_(TK_OC_EQ));
        break;
    case TK_OC_NE:
        print_nome(_(TK_OC_NE));
        break;
    case TK_LI_INT:
        print_nome(_(TK_LIT_INT));
        break;
    case TK_LI_FLOAT:
        print_nome(_(TK_LIT_FLOAT));
        break;
    case TK_ID:
        print_nome(_(TK_ID));
        break;
    case TK_ER:
        ...
        break;
    default:
        printf("<Token inválido com o código %d>\n", token);
        return RET_DESCONH;
        break;
    }
    return RET_SUCESSO;
